		...
		for(String specifica : separaStringheAlleVirgole(specificheStanze)) {
			...
			try (Scanner scannerDiLinea = new Scanner(specifica)) 	{	
				while (scannerDiLinea.hasNext()) {
					...
					check(scannerDiLinea.hasNext(),msgTerminazionePrecoce("c'e' stato qualche problema nella creazione dell'attrezzo per vedere la stanza "+specifica+"\n"));
		...
		for(String specifica : separaStringheAlleVirgole(specificheStanze)) {
			...
			try (Scanner scannerDiLinea = new Scanner(specifica)) 	{	
				while (scannerDiLinea.hasNext()) {
					...
					check(scannerDiLinea.hasNext(),msgTerminazionePrecoce("c'e' stato qualche problema nella creazione dell'attrezzo per sbloccare la stanza "+specifica+"\n"));
		...
		for(String specifica : separaStringheAlleVirgole(specificheStanze)) {
			...
			try (Scanner scannerDiLinea = new Scanner(specifica)) 	{	
				while (scannerDiLinea.hasNext()) {
					...
					check(scannerDiLinea.hasNext(),msgTerminazionePrecoce("c'e' stato qualche problema nella creazione dell'attrezzo per il mago della stanza "+specifica+"\n"));
